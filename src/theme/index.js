export default {
  ...
  colors: {
    ...
    primary: "#13192b", // primary button and link color
    secondary: "#0b557c", // secondary color - can be used for hover states
    muted: "#7B8188", // muted color
    accent: "#006fab", // a contrast color for emphasizing UI
    yellow: "#F6C416",
